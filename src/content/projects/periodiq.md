...
|---|---|
| Bohr model | Nucleus and orbiting electrons on tilted shells. Outer shells orbit slower than inner ones, because that's how it works. |
| Electron orbitals | Isosurfaces from real spherical harmonics Y(l, m). Positive and negative phases in complementary colors. Drill into individual orbitals (dxy, dz², dx²-y²). |
...
For the technical walkthrough of how those orbitals get drawn, see [Drawing electron orbitals from scratch](/blog/orbitals-from-scratch/). Live at [periodiq-three.vercel.app](https://periodiq-three.vercel.app).
